...
from dbsqlcli.sqlexecute import SQLExecute
from dbsqlcli.config import read_config_files, write_default_config, mkdir_p, AWSConfig
...
For more details about the error, you can check the log file: %s''' % (clirc, _cfg['main']['log_file'])
            self.echo(err_msg)
